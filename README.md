...
**Note: ** By default, Jenkins will not be accessible to the external world due to the inbound traffic restriction by GCP. open firewall rule with port 8080, if already exist then fine.


### Login to Jenkins using the below URL:

http://<vm-instance-public-ip-address>:8080    [You can get the vm-instance-public-ip-address from your GCP VM console page]
